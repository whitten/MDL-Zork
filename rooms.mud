...
<DEFINE RESTORE-FUNC (ST "AUX" (MUDDLE ,MUDDLE) STV)
...
<DEFINE SAVE-IT ASAVE-IT ("OPTIONAL" (FN <COND (<L? ,MUDDLE 100> "CFS;MADADV SAVE")
				      (T "<MDL>MADADV.SAVE")>)
		 (START? T)
	...
	<SETG SAVEREP ,REP>
	<SETG REP ,RDCOM>
	<COND (<AND <GASSIGNED? SAVE-EVAL> <SAVE-EVAL <FORM RESTORE-FUNC .ST> .FN>>
	       <COND (.START? <RETURN <RESTORE-FUNC .ST> .ASAVE-IT>)
                     (ELSE
